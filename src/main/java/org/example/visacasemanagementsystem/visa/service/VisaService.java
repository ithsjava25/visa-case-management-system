...
public class VisaService {
    ...
    public VisaService(VisaRepository visaRepository, UserRepository userRepository , VisaMapper visaMapper, AuditService auditService, FileService fileService) {
